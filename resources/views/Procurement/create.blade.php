                ...
                <div id="header">
                    ...
                    <div class="form-group row">
                        <div class="form-group col">
                            <label for="ppb_tgl_pengajuan" class="form-label">Tanggal Pengajuan <span class="text-red">*
                                    Wajib</span></label>
                            <input required class="form-control required" value="<?php echo date('Y-m-d'); ?>"
                                name="ppb_tgl_pengajuan" type="date">
                        </div>
                        <div class="form-group col">
                            <label for="ppb_tgl_deadline" class="form-label">Tanggal Diperlukan <span class="text-red">*
                                    Wajib</span></label>
                    ...
                    <div class="form-group">
                        <label for="ppb_alasan " class="form-label">Nama Pelanggan <span class="text-red">*
                                Wajib</span></label>
                        <input type="text" required class="form-control required"
                            value="{{ Auth::user()->name }}"name="ppb_pelanggan">
                        {{-- <input required class="form-control" value="" name="procNeed" type="text"> --}}
                    </div>
                    <div class="row form-group">
                        <div class="form-group col">
                            <label for="ppb_pengaju" class="form-label">Nama Pengaju <span class="text-red">*
                                    Wajib</span></label>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="form-group col">
                            ...
                            <input class="form-control required" required value="" id="NRP" name="ppb_nrp"
                                type="text">
                        </div>
                        <div class="form-group col">
                    ...
                    <div class="form-group">
                        <label for="ppb_alasan " class="form-label">Keperluan <span class="text-red">*
                                Wajib</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="selectgroup w-100">
                            ...
                            <label class="selectgroup-item">
                                <input checked type="radio" name="ppb_tipe" value="Non Inventory"
                    ...
                    <button class="btn btn-secondary btn-block nextButton" disabled type="button"
                        id="next">Next</button>
                </div>
                ...
                <div id="detail" style="display: none">
                    ...
                    <div class="nonimport">
                        ...
                        <table class="table" id="insert">
                            ...
                            <tbody>
                                <div id="errorMessage" style="display: none;">Kolom deskripsi tidak boleh menggunakan
                                    titik koma ; </div>
                                <tr>
                                    <td><input class="must_fill" required type="number" min=0 value="1"
                                            name="ppb_qty[]"></td>
                                    <td><input class="must_fill" required type="text"
                                            value="Pcs"name="ppb_satuan[]">Pcs</td>
                                    <td>
                                        <textarea required type="text"class="must_fill form-control descriptions requireds" placeholder="Deskripsi"
                                            pattern="^[^;]*$" name="ppb_deskripsi[]"></textarea>
                                    </td>
                                    <td><input required type="text"
                                            placeholder="Tipe"class="must_fill form-control ppb_tipe_barang"
                                            name="ppb_tipe_barang[]"></td>
                                    <td><input required type="text" placeholder="Merek"
                                            class="must_fill form-control ppb_merek" name="ppb_merek[]"></td>
                                    <td><input type="text" placeholder="Referensi/Panel"name="ppb_pemasok_panel[]">
                                    </td>
                                    <td><input type="button" placeholder="Delete" value="Del" onclick="del()">Delete
                                    </td>
                                </tr>
                            </tbody>
                        </table>
