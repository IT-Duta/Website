    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="edit-modalLabel">Pengajuan Barang General Affair</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form method='post' action="{{route('ga.permintaanUpdate')}}" id="edit-form" enctype="multipart/form-data">
                {!! csrf_field() !!}
                @if ($errors->any())
        ...
        <div class="modal-footer">
            <button type="submit"
                class="btn btn-primary btn-shadow btn-block" form="edit-form">
                Submit
            </button>
