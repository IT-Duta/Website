<div class="modal fade" id="diterima-modal" tabindex="-1" aria-labelledby="diterima-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="diterima-modalLabel">Pengajuan Barang General Affair</h5>
        ...
        <div class="modal-footer">
            <button type="submit"
                class="btn btn-primary btn-shadow btn-block" form="diterima-form">
                Submit
            </button>
