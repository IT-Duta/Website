            ...
            <form method="POST" action="{{ route('ait_update', $ait->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="input-group">
                                ...
                                <input required type="number" class="form-control" value="{{ $ait->price }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" name="ait_price">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md">
                            <input class="form-control" value="{{ date('d-m-Y H:i:s', strtotime($ait->buy_date)) }}" onfocus="(this.type='text')"
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md">
                            <input type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="form-control @error('ait_quantity') is-invalid @enderror" name="ait_quantity" value="{{ $ait->quantity }}" required>
                        </div>
                    </div>
                ...
                <div class="text-right mr-2">
                    <button type="submit" class="btn btn-primary btn-shadow btn-block mb-3">Submit</button>
                </div>
            </form>
        </div>
    </div>
